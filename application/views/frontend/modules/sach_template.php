...
<div class="list-product but-viet" style="background-color: white;">
    <div class="content-2" >
       <div class="baner" style="padding-top: 10px;">
                <img src="<?php echo base_url() ?>public/images/banner/banner_sach.png?>" class="d-block w-100">
        </div>
    </div>
    <div class="list-header-z"  style="background-color: #f6b6d3;     margin-top: -10px;">
        <div class="center-content">
            <h2 class="move-text">
            <img src="http://localhost/organica/public/images/hot.gif" alt=""> 
    ...
    <?php ?>
        <div class="carousel-container" >
           ...
           <div class="carousel" style="background-color: #f6b6d3;  margin-bottom: 10px;">
