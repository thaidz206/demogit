...
<div class="list-product but-viet" style="background-color: white;">
    <div class="content-2" >
       <div class="baner" style="padding-top: 10px;">
                <img src="<?php echo base_url() ?>public/images/banner/banner_butgel.png?>" class="d-block w-100">
        </div>
    </div>
    <div class="list-header-z" style="background-color: #ffcaaa; margin-top: -10px;">
    ...
    <?php ?>
        <div class="carousel-container" >
           ...
           <div class="carousel" style="background-color: #ffcaaa; margin-bottom: 10px;" >
